...
async def obtener_atributo_componente(componente_tipo: str, componente_modelo: str, session: AsyncSession = Depends(get_session)):
...
async def actualizar_componente_endpoint(componente_id: int, comp_update: ComponenteActualizado, session: AsyncSession = Depends(get_session)):
...
async def actualizar_distribuidor_endpoint(distribuidor_id: int, comp_update: DistriActualizado, session: AsyncSession = Depends(get_session)):
